					...
					<ul class="space-y-2.5 text-sm">
						{#each siteConfig.products.categories as category}
							<li>
								<Link
									href={category.href}
									class="text-text-muted hover:text-primary transition-colors flex items-center gap-2 group"
								>
									<svg
						...
						<li class="pt-2 border-t border-border-default mt-2">
							<Link
								href="/productos"
								class="text-primary hover:text-primary-hover font-semibold transition-colors flex items-center gap-2"
							>
				...
				<div>
					...
					<div class="space-y-4 text-sm">
						<div class="flex items-start gap-3">
							...
							<div>
								<Text class="font-semibold text-text-default"
									>Teléfono</Text
								>
								<Link
						...
						<div class="flex items-start gap-3">
							...
							<div>
								...
								<Text class="text-text-muted text-sm"
									...
									{siteConfig.contact.address.city}, {siteConfig
										.contact.address.province}</Text
								>
							</div>
						</div>
						<div class="flex items-start gap-3">
							...
							<div>
								...
								<Text class="text-text-muted text-sm"
									...
									{#if siteConfig.contact.schedule.saturday}
										<br />{siteConfig.contact.schedule
											.saturday}
									{/if}
								</Text>
							</div>
			...
			<div class="border-t border-border-default pt-6 sm:pt-8">
				...
				>
					<div class="text-text-muted text-center sm:text-left">
						...
						{siteConfig.company.name}. Todos los derechos
						reservados.
					</div>
					<div
						class="flex flex-wrap justify-center gap-x-4 gap-y-2 text-text-muted"
					>
						<Link
							href={siteConfig.legal.terms}
							class="hover:text-primary transition-colors min-h-[44px] flex items-center"
							>Términos</Link
						>
