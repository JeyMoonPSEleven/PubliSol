...
>
	...
	<div class="-z-30 blur-[2px] absolute inset-0 overflow-visible">
		<!-- spark -->
		<div
			class="absolute inset-0 aspect-square h-full animate-shimmer-slide"
		>
			<!-- spark before -->
			<div
				class="absolute -inset-full w-auto translate-x-0 rotate-0 animate-spin-around"
	...
	<!-- backdrop -->
	<div
		class="absolute -z-20 [inset:var(--cut)] [border-radius:var(--radius)] [background:var(--bg)]"
	></div>
</button>
